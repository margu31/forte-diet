  ...
  return (
    <PostingForm>
      ...
      <div>
        ...
        />
        <PostingInputRadio id='publicPost' name='state' value='public' label='Public' />
      </div>
      <div>
        <p>Type</p>
        <PostingInputRadio id='breakfast' name='mealType' value='breakfast' label='Breakfast' />
        <PostingInputRadio id='lunch' name='mealType' value='lunch' label='Lunch' />
        <PostingInputRadio id='dinner' name='mealType' value='dinner' label='Dinner' />
        <PostingInputRadio id='snack' name='mealType' value='snack' label='Snack' />
      </div>
